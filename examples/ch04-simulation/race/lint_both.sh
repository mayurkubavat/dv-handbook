...
#
# The race-free design passes -Wall in silence. The racing one earns
# BLKSEQ, "blocking assignment in sequential logic", which is off unless
# -Wall or -Wwarn-BLKSEQ turns it on, and is the one warning that would
...
racy_out=$(verilator $FLAGS -DDUT_RACY --top-module tb_race \
