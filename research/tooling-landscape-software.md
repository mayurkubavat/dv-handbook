...
| Sourcegraph (OSS core) | Code search across repos, uses SCIP for precise nav | Repo-wide search agents query via GraphQL API | API (GraphQL), web | Apache-2.0 core (some enterprise proprietary; vendor) | mature | https://github.com/sourcegraph/sourcegraph |
...
| Earthly | Dockerfile-like reproducible build syntax | Alternative | CLI | MPL-2.0 (project moved to maintenance 2025) | mature, low activity | https://github.com/earthly/earthly |
...
| Delta debugging (paper) | Zeller & Hildebrandt, "Simplifying and Isolating Failure-Inducing Input", TSE 2002 | The algorithm behind reducers and shrinkers | paper | n/a | research (foundational) | https://doi.org/10.1109/32.988498 |
...
| Agentic AI Foundation (Linux Foundation) | Neutral home for MCP, AGENTS.md and related projects (announced 2025-12) | Governance reference | web | n/a | active | https://www.linuxfoundation.org/press/linux-foundation-announces-the-formation-of-the-agentic-ai-foundation |
...
| Agent2Agent (A2A) protocol | Google-originated, now Linux Foundation, protocol for agent-to-agent task delegation: Agent Cards, tasks, streaming, push | Orchestrator delegates sub-tasks to specialist agents | JSON-RPC / HTTP | Apache-2.0 | active (v0.3, 2025) | https://github.com/a2aproject/A2A |
| A2A specification page | Spec text | Reference | web | Apache-2.0 | active | https://a2a-protocol.org/latest/specification/ |
| AGENTS.md | Convention: a Markdown file at repo root with build/test/style instructions for coding agents; adopted by many agents; under AAIF | Repo tells the agent how to work here | Markdown file | CC / MIT | active (2025) | https://agents.md/ |
